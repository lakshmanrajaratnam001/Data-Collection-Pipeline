...
class Scraper:
    ...
    def product_properties(self,dir2: str='./raw_data/images/'):
            ...
            '''
            #Image direcotry created if one does not exist yet
            ...
            for properties in property_list:
                    ...
                    #friendly product ID could not befound in database so data for this product will be scraped
                        ...
                        time.sleep(3)
                        self.friendly_id()
                        #image data downloaded to images directory
                        self.get_images()
                        id = str(uuid.uuid4())
            ...
            #data dumped in .json file once all product data is scraped
            self.dump_data()
    ...
    def dump_data(self,dir: str='./raw_data/', filename: str='data.json') -> None:
        ...
        '''
        #directory changed so .json file is dumped in raw_data
    ...
    def upload_to_cloud(self, engine):
      ...
      df.head()
      #uploads image data to Amazon S3
      self.upload_images()
